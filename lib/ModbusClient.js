...
*/
const connectionTypes = ['TCP','TcpRTUBuffered','Telnet','UDP','C701'];
const functionCodes = [ 'FC1','FC2','FC3','FC4','FC5','FC6','FC15','FC16'];
...
class ModbusClient extends EventEmitter{
    ...
    connect(config){
        return new Promise((resolve, reject) => {
            ...
            let connectionType = config.connection;
            let connectMethod = 'connect';
            switch(connectionType.toLowerCase()){
                case connectionTypes[0].toLowerCase():
                    connectMethod+=connectionTypes[0];
                    break;
                case connectionTypes[1].toLowerCase():
                    connectMethod+=connectionTypes[1];
                    break;
                case connectionTypes[2].toLowerCase():
                    connectMethod+=connectionTypes[2];
                    break;
                case connectionTypes[3].toLowerCase():
                    connectMethod+=connectionTypes[3];
                    break;
                case connectionTypes[4].toLowerCase():
                    connectMethod+=connectionTypes[4];
                    break;
                default:
